...
class SimpelPaguController extends Controller {
    ...
    //     if ($_POST['tahun']) {
    //         $sql = "SELECT b.*, c.unit_id, c.unit_id3 FROM serasi2015_sql.news_detail_keg as a 
    //                 INNER JOIN serasi2015_sql.news_sub_mak_tahun as b on a.suboutput_id=b.suboutput_id
    //                 INNER JOIN serasi2015_sql.news_nas_suboutput as c on b.suboutput_id=c.suboutput_id where b.kode_mak in (524113,524111,524119,524114)";
