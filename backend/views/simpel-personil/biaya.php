...
$('#satuan1').on('keyup', function(){
  ...
  $('#jml1').val(hasil);
  $('#uraian_rincian1').val("Tiket "+$('#kdtg').html()+",  "+$('#kkmbl').html()+" "+$('#kprov').html());
...
$('#satuan2').on('keyup', function(){
  ...
  $('#jml2').val(hasil);
  $('#uraian_rincian2').val("Taksi "+$('#kdtg').html());
...
$('#satuan3').on('keyup', function(){
  ...
  $('#jml3').val(hasil);
  $('#uraian_rincian3').val("Taksi "+$('#kkmbl').html());
...
$('#satuan4').on('keyup', function(){
  ...
  $('#jml4').val(hasil);
$('#uraian_rincian4').val(" Uang harian selama "+$('#idmakan').val()+"    hari di "+$('#kkmbl').html()+", "+$('#kprov').html()+" tgl. "+$('#dtg').html()+" sd "+$('#kmbl').html()+" @ Rp. "+$('#satuan4').val()+" x "+$('#volume4').val()+" = Rp. "+hasil+"");
});
...
$('#satuan5').on('keyup', function(){
  ...
  $('#jml5').val(hasil);
$('#uraian_rincian5').val(" Uang Saku Fullboard selama "+$('#idmakan').val()+"    hari di "+$('#kkmbl').html()+", "+$('#kprov').html()+" tgl. "+$('#dtg').html()+" sd "+$('#kmbl').html()+" @ Rp. "+$('#satuan5').val()+" x "+$('#volume5').val()+" = Rp. "+hasil+"");
...
$('#satuan6').on('keyup', function(){
  ...
  $('#jml6').val(hasil);
  $('#uraian_rincian6').val(" Penginapan selama "+$('#idmakan').val()+"    hari di "+$('#kkmbl').html()+", "+$('#kprov').html()+" tgl. "+$('#dtg').html()+" sd "+$('#kmbl').html()+" @ Rp. "+$('#satuan6').val()+" x "+$('#volume6').val()+" = Rp. "+hasil+"");
...
$('#satuan7').on('keyup', function(){
  ...
  $('#jml7').val(hasil);
$('#uraian_rincian7').val(" Penginapan Fullboard selama "+$('#idmakan').val()+"    hari di "+$('#kkmbl').html()+", "+$('#kprov').html()+" tgl. "+$('#dtg').html()+" sd "+$('#kmbl').html()+" @ Rp. "+$('#satuan7').val()+" x "+$('#volume7').val()+" = Rp. "+hasil+"");
...
$('#satuan8').on('keyup', function(){
  ...
  $('#jml8').val(hasil);
  $('#uraian_rincian8').val(" Representatif selama "+$('#idmakan').val()+"    hari di "+$('#kkmbl').html()+", "+$('#kprov').html()+" tgl. "+$('#dtg').html()+" sd "+$('#kmbl').html()+" @ Rp. "+$('#satuan8').val()+" x "+$('#volume8').val()+" = Rp. "+hasil+"");
...
$('#satuan9').on('keyup', function(){
  ...
  $('#jml9').val(hasil);
  $('#uraian_rincian9').val(" Transport Pimpinan / Expert / Inspeksi selama "+$('#idmakan').val()+"    hari di "+$('#kkmbl').html()+", "+$('#kprov').html()+" tgl. "+$('#dtg').html()+" sd "+$('#kmbl').html()+" @ Rp. "+$('#satuan9').val()+" x "+$('#volume9').val()+" = Rp. "+hasil+"");
