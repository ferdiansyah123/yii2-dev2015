    ...
    <div class="block">
        ...
        <div class="wp-posts-index">
            ...
            <div class="panel-heading">
                <h3 align="center" class="panel-title">Laporan Realisasi Unit Kerja</h3>
            </div>
                    ...
                    foreach ($unit as $unit) {
                        ...
                        switch ($unit->unit_id) {
                            ...
                            (SELECT a.id_kegiatan FROM simpel_keg a  LEFT JOIN 
                             pegawai.daf_unit b ON a.unit_id=b.unit_id WHERE a.status in (2,3,4) and a.tgl_mulai between '".$tgl_mulai."' and '".$tgl_kembali."' and g.bukti_kwitansi in(1,2) and 
                             b.unit_id 
                            ...
                            case 130000:
                             ...
                             FROM v_pagu where tahun=" . $tahun . " and unit_id in(131000,132000,133000)")->queryScalar();
                                ...
                                $totalreal = Yii::$app->db->createCommand("SELECT SUM(jml) as JUMLah FROM `simpel_rincian_biaya` as g WHERE id_kegiatan in 
                            (SELECT a.id_kegiatan FROM simpel_keg a  LEFT JOIN 
                             pegawai.daf_unit b ON a.unit_id=b.unit_id WHERE status in (2,3,4) and a.tgl_mulai between '".$tgl_mulai."' and '".$tgl_kembali."' and g.bukti_kwitansi in(1,2) and 
                             b.unit_id 
                             IN (SELECT c.unit_id FROM  pegawai.daf_unit c  WHERE c.unit_parent_id in (131000,132000,133000) ))")->queryScalar();
                                break;
                            case 161100:
