...
$this->title = Yii::t('app', 'Laporan Realisasi Per Unit Kerja Mak');
...
<h2 align="center">LAPORAN REALISASI UNIT KERJA PER AKUN</h2>
...
<h2 align="center" style="padding-top:-20px;"><?= MyHelper::Formattgl($_GET['tgl_mulai']) ?> s/d  <?= MyHelper::Formattgl($_GET['tgl_kembali']) ?></h2>
                ...
                foreach ($unit as $unit) {
                    ...
                    <tr bgcolor="white" >
                        <th><?= $no ?>.</th>
                        <th bgcolor="white" > <?= \common\components\HelperUnit::Apagu($unit->unit_id) ?></th>
