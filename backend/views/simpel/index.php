        ...
        <table class="table1 table-striped" width="100%">
            <thead>
                <tr>
                    ...
                    <center>Pagu</center>
                    <font size="1">(&nbsp;&nbsp;524111,524113,524114,524119 &nbsp;&nbsp;)</font>
                    </th>
                ...
                foreach ($satker as $unit) {
                        ...
                        case 110000:
                            ...
                            (SELECT a.id_kegiatan FROM simpel_keg a  LEFT JOIN 
                             ...
                             $sql = "SELECT sum(c.har_sat_real) FROM serasi2015_sql.news_detail_keg as a
                                ...
                                and g.kode_mak in (524111,524113,524114,524119)
                    ...
                    foreach ($satker as $sat) {
                        ...
                        <tr>
                            ...
                            <td align="right"><?php
                            if($pag>0){
                                echo number_format((($re+HelperUnit::PaguSerasi($sat->unit_id)) / $pag) * 100, 2, ",", ".");
                                }else{
                                    echo "0";
                                }
                                ?> %
