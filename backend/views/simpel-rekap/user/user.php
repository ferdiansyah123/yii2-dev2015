    ...
    <div class="block">
        <div class="block-title">
            <ul class="nav nav-tabs ">
                <li  class="active" >
                    <a href="<?= Url::to(['simpel-rekap/user']) ?>" >
                    Rekapitulasi Perjadin</a>
                </li>
                <li>
                    <a href="<?= Url::to(['simpel-rekap/userkeg']) ?>" >
                    Rekapitulasi Kegiatan</a>
                </li>
                <li>
                    <a href="<?= Url::to(['simpel-rekap/usermonikeg']) ?>" >
            ...
            <?php if(!empty($_GET)){ ?>
            <h1 align="center"><?= HelperUnit::unit($_GET['unit']).'  -  '.HelperUnit::unit(HelperUnit::ParentUnit($_GET['unit'])) ?> </h1>
            <p align="right">
            <a href="<?= Yii::$app->urlManager->createUrl(['simpel-rekap/exportuser','unit'=>$_GET['unit'],'tgl_mulai'=>$_GET['tgl_mulai'],'tgl_kembali'=>$_GET['tgl_kembali']]) ?>" >
