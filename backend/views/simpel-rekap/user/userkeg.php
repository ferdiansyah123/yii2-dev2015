    ...
    <div class="block">
        ...
        <div class="panel panel-primary">
           ...
           <?= $this->render('/simpel-rekap/pencarian/_usercari') ?>
            <?php if(!empty($_GET)){ ?>
            <h1 align="center"><?= HelperUnit::unit($_GET['unit']).'  -  '.HelperUnit::unit($_GET['unit']) ?> </h1>
            <p align="right">
             <a href="<?= Yii::$app->urlManager->createUrl(['simpel-rekap/export-pdf','unit'=>$_GET['unit'],'tgl_mulai'=>$_GET['tgl_mulai'],'tgl_kembali'=>$_GET['tgl_kembali']]) ?>" >
