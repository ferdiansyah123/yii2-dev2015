                       ...
                       <?php }else{
                        ...
                        <?php for ($i = 01; $i <= 31; $i++) { ?>
                            ...
                            if($model['pegawai_id']>0){
                                ...
                                $count = Yii::$app->db->createCommand("SELECT count(nip) from simpel_personil where nip=".$model['nip']." and tgl_berangkat='".$tahun.'-'.$bln.'-'.$da."' group by nip")->queryScalar();
                            }
                            if($count > 0){ ?>
                                ...
                                $data = \backend\models\SimpelPersonil::find()->where('pegawai_id='.$model['pegawai_id'].' and id_kegiatan')->all();
