                                ...
                                <tr>
                                        ...
                                        <div >
                                            ...
                                            switch ($sat->unit_id) {
                                                case 110000:
                                                    ?>
                                                    <h6> <?=
                                                        Html::a(HelperUnit::Apagu($sat->unit_id), Yii::$app->urlManager->createUrl(['simpel-keg/tabcetak', 'unit' => $sat->unit_id]), [
                                                ...
                                                case 161100:
                                                    ?>
                                                    <h6> <?=
                                                        Html::a('Inspektorat', Yii::$app->urlManager->createUrl(['simpel-keg/tabcetak', 'unit' => '151000']), [
                                                            'title' => Yii::t('yii', 'Proses'),
                                                        ])
                                                        ?> </h6>  
                                                ...
                                                case 151000:
                                                    ?>
                                                    <h6> <?=
                                                        Html::a(HelperUnit::Apagu($sat->unit_id), Yii::$app->urlManager->createUrl(['simpel-keg/tabcetak', 'unit' => '161100']), [
                                                            'title' => Yii::t('yii', 'Proses'),
                                                        ])
                                                        ?> </h6>  
                                    ...
                                    <td width="120" align="center">
                                     <?php
                                        switch ($sat->unit_id) {
                                            case 161100:
                                                $hitung = "SELECT count(a.id_kegiatan) FROM simpel_keg a LEFT JOIN pegawai.daf_unit b on a.unit_id=b.unit_id WHERE status=2 and b.unit_parent_id='".$sat->unit_id."' ";
