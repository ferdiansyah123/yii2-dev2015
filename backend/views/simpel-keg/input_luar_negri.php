...
<table align="center" border="0" width="100%" cellpadding="0" cellspacing="0">
    <tr><td>
            ...
            <?php echo $form->field($model, 'id_kegiatan')->hiddenInput(['value' => $model2->id_kegiatan])->label(false) ?>
            <!-- Smart Wizard -->
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                          <select id="dropDown" class="form-control">
                            ...
                            <option value="div1">Pegawai </option>
                            <option value="div2">Non Pegawai</option>
                         </select>
                ...
                <div id="step-2">
                    ...
                    <table width="1000px" class="table table-striped table-bordered">
                        <tr style="background-color:#4e95f4;">
                            ...
                            <td width="100" align="center">Bukti Kwitansi </td>
                        ...
                        <tbody id="container">
                            ...
                            foreach ($input as $ke) {
                                ...
                                echo Select2::widget([
                                    ...
                                    <input id="<?php echo 'volume' . $no ?>" class="form-control" name="<?php echo 'volume' . $no; ?>" type="text">

                                    <?php
                                    echo ' </td>';
                                    echo ' <td width="5%" align="center">';
                                    ?>
                                    <input id="<?php echo 'pagu' . $no ?>" class="form-control" name="<?php echo 'pagu' . $no; ?>" type="text">

                                    <?php
                                    echo ' </td>';
                                    echo ' <td width="5%" align="center">';
                                    ?>
                                    <input id="<?php echo 'persen' . $no ?>" class="form-control" name="<?php echo 'persen' . $no; ?>" type="text">
                                ...
                                case "6":
                                    ...
                                    <textarea id="<?php echo 'uraian' . $no ?>" rows="6" class="form-control" name="<?php echo 'uraian' . $no; ?>"> </textarea>
                                    <input id="<?php echo 'volume' . $no ?>" class="form-control" name="<?php echo 'volume' . $no; ?>" type="hidden">
                                    <input id="<?php echo 'satuan' . $no ?>" class="form-control" name="<?php echo 'satuan' . $no; ?>" type="hidden">
                                    <input id="<?php echo 'jml' . $no ?>" class="form-control" name="<?php echo 'jml' . $no; ?>" type="hidden">
